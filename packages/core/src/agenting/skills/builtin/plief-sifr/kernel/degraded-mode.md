...
| video/canvas/WebGL playback or GPU inspection | verify static source, contracts, fallbacks and technical gates; do not infer choreography, dynamic contrast or frame performance from stills | "DYNAMIC MEDIA: UNVERIFIED" + missing keyframes/runtime cases |
