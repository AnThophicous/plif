# Project-type Assessment Matrix (Pli'ef Argus routing aid)

Historical note: migrated intact from the legacy plif-cybersecurity package; consumes SecurityIR classification instead of prose discovery. JIT-load only after project type identified.
